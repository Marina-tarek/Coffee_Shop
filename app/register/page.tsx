    ...
    <div className="flex items-center justify-center h-[100vh]">
      <div className="relative z-10 bg-white/10 backdrop-blur-md p-8 rounded-2xl shadow-xl max-w-md w-full">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            <label htmlFor="name" className="block mb-2 text-sm text-gray-200">Full Name</label>
            <input
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-2 mt-4 py-2 border border-gray-300 rounded-lg bg-white hover:bg-gray-100 transition duration-300 text-gray-800 font-semibold"
        >
        ...
        <p className="text-sm text-center text-gray-300 mt-4">
          Already have an account? <a href="/login" className="text-amber-400 hover:underline">Log in here</a>
        </p>
      </div>
    </div>
  );
